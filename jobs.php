        ...
        <div class="section">
            ...
            <div class="container">
                ...
                $sql = "SELECT * FROM job_adverts ";
                    ...
                    <div class="col-md-7">
                        <a href="#">
                            <img src="product_img/' . $row['name'] . '" alt="" height="60" style="float:right; height:200px; width:300px; margin:10px;" class="img img-thumbnail">
                        </a>
                    </div>
                    <div class="col-md-5">
                        <h3>JOB TITLE: ' . $row['job_title'] . '</h3>
                        <p>MWAJIRI: ' . $row['company_name'] . '</p>
                            <p>EXPERIENCE: </p>
                            <p>PUBLISHED DATE: </p>
                            <p>DEADLINE: ' . $row['deadline'] . '</p>
                        <a class="btn btn-primary" href="job.php?job_id=' . $row['job_id'] . '">View Job
                            <span class="glyphicon glyphicon-chevron-right"></span>
                        </a>
                    </div>
                </div>
                <!-- /.row -->' . mysqli_error($link);
                            }
                        }
                ?>
                <!-- /Product details -->
