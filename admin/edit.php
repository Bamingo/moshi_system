            ...
            <div class="container-fluid">
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">MANAGE USERS</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">MANAGE JOB UPLOADED</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="manage_job.php">
                                <span class="float-left">View Details</span>
                                <span class="float-right">
                                    <i class="fa fa-angle-right"></i>
                                </span>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-success o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">MANAGE MATANGAZO</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="matangazo.php">
                                <span class="float-left">View Details</span>
                                <span class="float-right">
                                    <i class="fa fa-angle-right"></i>
                                </span>
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fa fa-edit"></i> Edit Data Table</div>
                    <div class="card-body">
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($results)) {
                                echo'<form action="edit.php" class="form-group-sm" method="post" style="text-align: left; margin-top: 10px;" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="" name="product_name" value="' . $row['product_name'] . '">
                                    </div>
                                    <label for="email">Aina ya Bidhaa:</label>
                                    <div class="form-group">
                                        <select class="form-control" name="category" value="' . $row['category'] . '">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="" name="quantity" value="' . $row['quantity'] . '">
                                    </div>
                                    <div class="form-group">
                                        <label for="tetx">Weka Picha:</label>
                                        <input type="file" class="form-control" id="" name="file" value="' . $row['name'] . '">
                                    </div>
                                    <div class="form-group">
